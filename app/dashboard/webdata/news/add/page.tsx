...
import { createNews, getNewsTypes, getNewsSubTypes, type NewsItem } from '../apis'
...
export default function AddNewsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('News Form Data:', newsData)
    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Create a new news article or event</p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter the basic information for the news article</CardDescription>
          </CardHeader>
