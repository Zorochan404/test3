...
export default function EditDownloadPage() {
  ...
  const loadDownloadItem = useCallback(async () => {
    try {
      setInitialLoading(true)
      console.log('Loading download with ID:', id) // Debug log
      const item = await getDownloadById(id)
      console.log('Loaded download:', item) // Debug log
      if (item) {
      ...
      toast.error('Failed to load download. Please check if the backend is running.')
    } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : 'Failed to update download')
    } finally {
      setLoading(false)
    }
  }
    ...
    return (
      <div className="p-6 max-w-4xl mx-auto">
        <div className="flex justify-center items-center h-64">
          <div className="text-lg">Loading download...</div>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="p-6 max-w-4xl mx-auto">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-6">The download you&quot;re trying to edit doesn&quot;t exist.</p>
          <Button asChild>
    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Update the download information</p>
        </div>
        <div className="flex gap-2">
          ...
          <Button variant="outline" asChild>
            <a href={downloadItem.fileUrl} target="_blank" rel="noopener noreferrer">
              Preview PDF
            </a>
          </Button>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update the basic details of your download</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Current file or upload a new PDF to Cloudinary (Max 10MB)</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
