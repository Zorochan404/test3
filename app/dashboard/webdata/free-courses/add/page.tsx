...
import { createFreeCourse, type FreeCourseData, type CourseDetails } from '../apis'
...
export default function AddFreeCoursePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createFreeCourse(cleanedData)
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Add New Free Course</h1>
        <p className="text-gray-600">Create a new free course for students</p>
      </div>
